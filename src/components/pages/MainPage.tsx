...
export function MainPage({ onHandleLoginNavigate }: MainPageProps) {
  return (
    <div className="min-h-[calc(100vh-theme(spacing.16)-theme(spacing.16))]">
      <section className="bg-gradient-to-br from-sky-50 to-blue-50 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-gray-900 mb-6">Система опросов</h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Современная платформа для создания, прохождения и анализа опросов.
            Удобное управление опросами для преподавателей, простое прохождение
            для студентов.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-gray-900 mb-4">Возможности системы</h2>
            <p className="text-gray-600 text-lg">
              Простое и эффективное решение для всех участников учебного
              процесса
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-gray-900 mb-2">Простота использования</h3>
              <p className="text-gray-600">
                Интуитивный интерфейс для создания и прохождения опросов
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-gray-900 mb-2">Мощная аналитика</h3>
              <p className="text-gray-600">
                Детальная статистика и визуализация результатов опросов
              </p>
            </div>
